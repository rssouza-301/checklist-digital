...
<div class="container my-4">
    <div class="card shadow-sm">
        <div class="card-header bg-success text-white">
            <h4 class="mb-0"><i class="bi bi-box-arrow-right"></i> Checklist de ABERTURA</h4>
        </div>
        <div class="card-body">
            <form action="salvar_abertura.php" method="POST" id="checklistForm">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#checklistAccordion">
                            <div class="accordion-body">
                                ...
                                <label for="lacres" class="form-label fw-bold">Nº dos Lacres Retirados:</label>
                                <textarea class="form-control" id="lacres" name="lacres_retirados" rows="3" placeholder="Ex: Portão 1: 12345, Portão 2: 12346"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-grid gap-2 mt-4">
                    <button type="submit" class="btn btn-success btn-lg">Registrar Abertura</button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(event) {
        ...
        .finally(() => {
            ...
            submitButton.innerHTML = 'Registrar Abertura';
        });
    });
});
</script>
